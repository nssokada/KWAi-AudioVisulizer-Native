package sample;/* autogenerated by Processing revision 1280 on 2022-04-23 */
...
public class control_panel extends PApplet {
...
smooth(); }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "control_panel" };
    if (passedArgs != null) {
